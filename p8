...
# Example: Classify a new sample (you can modify the sample values as per your needs) 
# Sample: [mean radius, mean texture, mean perimeter, mean area, mean smoothness, ...] 
new_sample = np.array([[14.3, 18.1, 92.8, 600.1, 0.097, 0.084, 0.083, 0.080, 0.077, 0.064, 0.087, 0.087, 
0.077, 0.089, 0.085, 0.085, 0.080, 0.095, 0.087, 0.090, 0.091, 0.080, 0.076, 0.080, 0.092, 0.079, 0.089, 
0.090, 0.091, 0.089]])  # Sample with values 
